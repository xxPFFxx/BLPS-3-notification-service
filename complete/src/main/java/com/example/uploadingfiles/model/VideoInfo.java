...
public class VideoInfo {
    ...
    public VideoInfo(String name, String desc, String category, String releasetime, String releasedate, String link, Integer views, User user, Boolean popular, Integer notificationssent) {
        this.link = link;
        this.name = name;
        this.desc = desc;
